...
export function rename_photo_folder(photo: { file_rel_path: string, file_extension: string }): void {
  const [_, photo_folder_name] = photo.file_rel_path.match(/(\S+)\//) as RegExpMatchArray;
